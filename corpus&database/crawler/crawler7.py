            ...
            if isinstance(objs[i], pdfminer.layout.LTTextBox):
                for o in objs[i]._objs:
                    if isinstance(o,pdfminer.layout.LTTextLine):
                        ...
                        text = text[:-1]
                        # print (text)
                        if text.encode('ascii','ignore') == 'COMP9444' or text.encode('ascii','ignore') == 'c(cid:13)Alan Blair, 2018' or text.encode('ascii','ignore') == 'c(cid:13)Alan Blair, 2013-19' or text.encode('ascii','ignore') == 'c(cid:13)Alan Blair, 2013-18' or text.encode('ascii','ignore') == 'UNSW':
...
document = open('wk11_LearningGames.pdf', 'rb')
